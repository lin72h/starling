...
ROOT="$OUT/starling-desktop_${VER}_amd64"
...
DOC=$ROOT/usr/share/doc/starling-desktop
mkdir -p "$DOC"
...
Apache-2.0    /usr/share/doc/starling-desktop/LICENSE.Apache-2.0
BSD-3-Clause  /usr/share/doc/starling-desktop/LICENSE.BSD-3-Clause.flutter
...
Description: Starling desktop shell
 Wayland desktop environment with a Flutter/Swift shell, its own
...
ls -lh "$OUT"/starling-desktop_${VER}_amd64.deb
