...
for v in FLUTTER_DRM_DPI FLUTTER_DRM_CONNECTOR FLUTTER_DRM_MODE FLUTTER_VT \
         ...
         STARLING_TERM_ATLAS STARLING_TERM_METRICS \
         STARLING_SWAPCHAIN_DEBUG STARLING_FRAME_LOG STARLING_PUMP_LOG \
         STARLING_SCREENSAVER_TEST STARLING_SCREENSAVER_IDLE \
         STARLING_AERIAL STARLING_AERIAL_RES \
         STARLING_RDP STARLING_RDP_PORT STARLING_RDP_FPS \
         STARLING_RDP_CERT STARLING_RDP_KEY \
         STARLING_ROOM STARLING_ROOM_DIR STARLING_ROOM_LIB STARLING_ROOM_SUN_LUX \
         STARLING_ROOM_IBL_LUX STARLING_ROOM_EXPOSURE STARLING_ROOM_FX STARLING_ROOM_SCREEN STARLING_3D_LOG; do
    [ -n "${!v:-}" ] && ENV_ARGS+=("$v=${!v}")
done
